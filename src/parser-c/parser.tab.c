...
#define yyparse         xm_yyparse
#define yylex           xm_yylex
#define yyerror         xm_yyerror
#define yylval          xm_yylval
#define yychar          xm_yychar
#define yydebug         xm_yydebug
#define yynerrs         xm_yynerrs
#define yylloc          xm_yylloc

/* Copy the first part of user declarations.  */

/* Line 189 of yacc.c  */
#line 15 "/home/vdust/developpement/GIT/xm-coll-parser/src/parser.y"
...
{
  "$end", "error", "$undefined", "TOKEN_INTEGER", "TOKEN_PROP_SHORT",
  "TOKEN_PROP_LONG", "TOKEN_STRING", "TOKEN_PATTERN", "TOKEN_NUMERIC",
  "TOKEN_GROUP_OPEN", "TOKEN_GROUP_CLOSE", "TOKEN_SYMBOL_ID",
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, xm_context_t *context, void *scanner)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, xm_context_t *context, void *scanner)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, context, scanner)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, xm_context_t *context, void *scanner)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, context, scanner)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    xm_context_t *context;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, context, scanner); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, xm_context_t *context, void *scanner)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, context, scanner)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (xm_context_t *context, void *scanner);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (xm_context_t *context, void *scanner)
#else
int
	...
	if (0 < yysize && yysize <= yymsg_alloc)
	  {
	    ...
	    yyerror (&yylloc, context, scanner, yymsg);
	  }
	else
	  {
	    yyerror (&yylloc, context, scanner, YY_("syntax error"));
